...
sys.path.insert(0,"/home/orion/git/sentence_transformers")
sys.path.insert(0,"/home/orion/git/sentence_transformers/sentence_transformers")
...
def main():
    ...
    word_embedding_model = models.RoBERTa(args.model_name_or_path, max_seq_length=510, do_lower_case=True)
...
def load_and_cache_examples(args, sts_reader, model, evaluate=False):
    ...
    if os.path.exists(cached_features_file):
        ...
        train_data = SentencesDataset(sts_reader.get_examples('part{}.tsv'.format(args.part_no), max_examples=args.max_example), model)
