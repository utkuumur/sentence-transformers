...
class RoBERTa(nn.Module):
    ...
    def __init__(self, model_name_or_path: str, max_seq_length: int = 128, do_lower_case: bool = True):
        ...
        self.fast_tokenizer = RobertaTokenizerFast.from_pretrained(model_name_or_path, do_lower_case=do_lower_case, add_special_tokens=False)
    ...
    def tokenize(self, text: str) -> List[int]:
        ...
        #fast_tokenizer
        return self.fast_tokenizer.convert_tokens_to_ids(self.fast_tokenizer.tokenize(text))[1:-1]
